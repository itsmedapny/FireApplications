...
from fire.models import Locations, Incident, FireStation, FireTruck, Firefighters, Incident
...
from fire.forms import FirestationForm, FiretruckForm, FirefightersForm, IncidentForm
